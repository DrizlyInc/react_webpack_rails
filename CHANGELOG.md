...
- updated packages, specifically react to 16.3.0 and react-dom to 16.0.1
- update script building (npm@5 no longer uses prepublish)
...
- support Rails 5: - added Turbolinks 5 compatibility, - added Rails 5 dummy app for testing.
...
**_note_**: _generator will ask you to override existing package.json. Don't worry about its content - generator will merge existing package with the one from gem._
